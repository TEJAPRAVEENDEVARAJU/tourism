...
<header>
    ...
    <button class="logos"><a href="index.php" class="logo" style="font-family:richard"><span  style="color:red">T</span>ravel<span  style="font-family:magneto;color:rgb(54, 211, 255)">AP</span></a></button>
    ...
    <div class="action">
        <div class="profile">
            <a href="login.php"  style="padding-left:17%">
            <img src="images/logimage.png" alt="" style="height:40px;width:40px;padding-right:0px"></a>
        </div>
    </div>
...
<div class="login-form-container">
    ...
    <form action="">
       <center><img src="images/log.jpeg" width="100px" height="90px"></center>
        ...
        <b><p>Don't have an account? <a href="signup.php" target="_blank">Sign Up</a></p></b>
    </form>
...
<section class="home" id="home">
    ...
    <div class="content">
        ...
        <a href="login.php" target="_blank" class="btn">Explore Places</a>
    </div>
...
<section class="book" id="book">
    ...
    <div class="row">
        ...
        <form action="">
            ...
            <a href="login.php" class="btn" target="_blank">Book Now</a>
        </form>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <a href="login.php" target="_blank" class="btn">book now</a>
            </div>
        </div>
...
<br></br>
<center><a href="login.php" target="_blank" class="btn" style="font-size:50px">More</a></center>
</section>
